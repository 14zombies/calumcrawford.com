...
#FROM quay.io/curl/curl-base:latest as builder
FROM ubuntu as builder
ARG HUGO_VERSION=0.121.0
ARG RELEASE_TAR=https://github.com/gohugoio/hugo/releases/download/v${HUGO_VERSION}/hugo_extended_${HUGO_VERSION}_linux-amd64.tar.gz
